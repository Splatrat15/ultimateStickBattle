export const kaonMoveset = {
  // Light Attacks
  neutralLight: { name: 'Orb Jab', type: 'light', damage: 2, knockback: 1, duration: 20, cooldown: 20, hitbox: { width: 20, height: 20, offsetX: 60, offsetY: 20 } },
  sideLight: { name: 'Ki Orb', type: 'light', damage: 3, knockback: 2, duration: 28, cooldown: 30, hitbox: { width: 15, height: 15, offsetX: 80, offsetY: 25 } },
  upLight: { name: 'Orb Pop', type: 'light', damage: 2, knockback: 4, verticalKnockback: true, duration: 24, cooldown: 25, hitbox: { width: 40, height: 40, offsetX: 10, offsetY: -40 } },
  downLight: { name: 'Pulse Sweep', type: 'light', damage: 1, knockback: 0.5, duration: 22, cooldown: 30, hitbox: { width: 100, height: 20, offsetX: -20, offsetY: 40 } },
  // Heavy Attacks
